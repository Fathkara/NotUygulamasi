...
//  NotUygulaması
//
//  Created by Fatih on 16.09.2022.
//
...
class Notlardao {
    ...
    func notKayit(ders_adi:String,not1:Int,not2:Int) {
        db?.open()
    ...
    func notGuncelle(ders_adi:String,not1:Int,not2:Int,not_id:Int) {
        db?.open()
